        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center mb-24 relative">
            ...
            >
              ...
              <div className="w-px h-3 bg-slate-350" />
              <span className="text-slate-600 font-extrabold flex items-center gap-1">
                <Sparkles size={12} className="text-red-600 animate-spin" /> PROGRAM WI1101 ITB
              </span>
            </motion.div>
            ...
            >
              ...
              <span className="bg-gradient-to-r from-red-650 to-red-600 bg-clip-text text-transparent">
                "TAPAK LIMAN"
              </span>
            </motion.h1>
              ...
              {stats.map((s, idx) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <span className="text-[11px] font-bold text-slate-550 mt-1 block">{s.desc}</span>
                  </div>
                </motion.div>
              ))}
            </div>
                ...
                <div key={step.week} className="relative">
                  ...
                  >
                    <div className="flex items-center gap-3 mb-2">
                      <span className="px-2.5 py-0.5 rounded-full bg-red-550 bg-red-650 text-white text-[9px] font-black uppercase">
                        {step.week}
                      </span>
                    </div>
                      ...
                      <div key={bab.id} className={`border rounded-2xl overflow-hidden transition-all duration-300 ${isOpen ? 'border-red-600 bg-red-50/5' : 'border-slate-200/80 bg-white'}`}>
                        <button
                          ...
                          className={`w-full p-4 text-left font-black text-xs uppercase tracking-wider flex items-center justify-between transition-colors ${
                            isOpen ? 'text-red-650' : 'hover:bg-slate-50 text-slate-650'
                          }`}
                        >
                          <div>
                  ...
                  {grading.map((g) => (
                    <div key={g.name} className="space-y-1">
                      ...
                      <div className="h-2 w-full bg-slate-100 rounded-full overflow-hidden">
                        <div 
                          className="h-full rounded-full bg-red-650" 
